...
export declare class DaterangepickerComponent implements OnInit {
    ...
    ngOnInit(): void;
    renderRanges(): void;
    renderTimePicker(side: any): void;
     ...
     */
    monthChanged(monthEvent: any, side: any): void;
    /**
     * called when year is changed
     * @param yearEvent get value in event.target.value
     * @param side left or right
     */
    yearChanged(yearEvent: any, side: any): void;
    /**
     * called when time is changed
     * @param timeEvent  an event
     * @param side left or right
     */
    timeChanged(timeEvent: any, side: any): void;
    /**
     ...
     * @param side left or right
     */
    monthOrYearChanged(month: number, year: number, side: any): void;
    /**
     * Click on previous month
     * @param side left or right calendar
     */
    clickPrev(side: any): void;
    /**
     * Click on next month
     * @param side left or right calendar
     */
    clickNext(side: any): void;
    /**
